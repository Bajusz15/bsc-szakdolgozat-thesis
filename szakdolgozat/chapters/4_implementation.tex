...
A mérés közben a PostgreSQL adatbázis nem tudta kezelni a túl sok kapcsolatot, így 3-szor hibával tért vissza a mentés.
...
\subsubsection{HTTP/2 gRPC, PostgreSQL adatbázissal}
