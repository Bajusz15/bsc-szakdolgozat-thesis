...
Ha egy atomi, mutex, vagy csatorna operáció hívás miatt Gorutin blokkolni fog, az ütemező kontextus cserével egy új gorutinnak adhat erőforrást. Ha a régi Gorutin újra futtathatóvá válik, sorba állítja az ütemező és végül visszakapja az erőforrást.\\
...
Pár vállalat aki használja a Go-t:
\begin{itemize}
